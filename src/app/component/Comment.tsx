  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      >
        ...
        <input
          className="text-center p-3 bg-slate-900 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
          type="text"
        ...
        />
        <button
          className="p-3 bg-slate-900 text-white rounded-full hover:bg-blue-600 transition duration-200"
          type="submit"
        >
          Submit
        </button>
