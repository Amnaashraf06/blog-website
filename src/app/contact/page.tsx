...
const page = () => {
  return (
    <div id='contact' className='bg-purple-200'>
    <div className="lg:w-1/3 md:w-1/2 bg-purple-200 md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <button className="text-white bg-slate-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">
       Send Message
      </button>
